...
class MetalScraper:
    ...
    def crawler():
        ...
        # URL inicial.
        target_url = MetalScraper.current_target_url(page, display_start)

        # Records totales y entradas de la primera página.
        total_records = 1
        json_data = MetalScraper.get_json_data(target_url)
        ...
        while current_records < total_records:
            ...
            for x in range(500):
                ...
                if r.status_code == 200:
                    ...
                    MetalScraper.get_band_attributes(soup)
                    MetalScraper.get_band_disco(soup, current_records)
                    MetalScraper.get_band_members(soup, current_records)
